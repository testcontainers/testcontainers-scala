...
object TestContainerForEachSpec {
  ...
  protected class TestSpec(testBody: => Unit, contDef: ContainerDef)
    extends AnyFlatSpec with TestContainerForEach {
  ...
  protected class MultipleTestsSpec(testBody: => Unit, contDef: ContainerDef) extends AnyFlatSpec with TestContainerForEach {
  ...
  protected class TestSpecWithAllIgnored(testBody: => Unit, contDef: ContainerDef) extends AnyFlatSpec with TestContainerForEach {
